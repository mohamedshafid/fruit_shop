...
const Hero = () => {
  return (
    <section>
      <div className="bg-hero-banner bg-cover bg-center h-[80vh] relative rounded-lg">
        <div className="absolute inset-0 bg-black opacity-80 rounded-xl">
          <div className="flex flex-col items-center justify-center h-full px-4 sm:px-6 md:px-10 lg:px-16">
            ...
            <div className="mt-8">
              <button className="bg-white text-primary px-6 py-3 rounded-md hover:bg-violet-800 transition duration-200 cursor-pointer">
                Shop Now
              </button>
            </div>
          </div>
